 #include <WhatabotAPIClient.h>
          ...
          #define WHATABOT_API_KEY "55a6355c-e089-4736-b2b1"
          #define WHATABOT_CHAT_ID "+918310194568"
          ...
          //You must connect to the generated network, and from there.
          //you can set the SSID and password for your Wi-Fi network to which the ESP8266 will connect.
